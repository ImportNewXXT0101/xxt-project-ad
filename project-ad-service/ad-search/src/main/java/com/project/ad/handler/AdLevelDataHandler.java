package com.project.ad.handler;

import com.alibaba.fastjson.JSON;
import com.project.ad.dump.table.*;
import com.project.ad.index.DataTable;
import com.project.ad.index.IndexAware;
import com.project.ad.index.adplan.AdPlanIndex;
import com.project.ad.index.adplan.AdPlanObject;
...
import com.project.ad.index.creativeunit.CreativeUnitObject;
...
/**
 * @Description: 1、索引之间存在层级的划分，也就是依赖关系的划分
 * 2、加载全量的索引其实是增量索引 “增加” 的一种特殊实现
 * @Author: ChengChuanQiang
 * @Date: 2019/5/12 11:03
 */
@Slf4j
